<?php
/* $Id: starter_pcos.php,v 1.14.2.2 2014/12/12 12:47:18 rp Exp $
 *
 * pCOS starter:
...
try {
	...
	$contents = $p->pcos_get_stream($doc, "", "/Root/Metadata");
        printf("%d bytes <br/>", strlen($contents));

        /* This demonstrates Unicode conversion */
        $dummy = $p->convert_to_unicode("utf8", $contents,
                       "outputformat=utf16");
        printf("(%d Unicode characters)<br/><br/>", strlen($dummy)/2);
